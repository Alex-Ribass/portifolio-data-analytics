...
### 1. Python & Pandas (Tratamento e Automação)

- **Manipulação de Dados:** Limpeza, filtragem, tratamento de valores ausentes e engenharia de recursos.
- **Lógica e Regras de Negócio:** Aplicação de condicionais complexas com `numpy.select` e `.loc`.
...
- **Modelagem Dimensional:** Conexão de dados, relacionamentos e construção do esquema estrela (_Star Schema_).
- **Métricas DAX:** Criação de medidas calculadas, colunas e análises temporais (_Time Intelligence_).
- **Dashboards Interativos:** Layouts focados na experiência do usuário (UX/UI) e navegação para tomada de decisão executiva.
...
Objetivo: Transição de carreira para a área de Análise de Dados, Engenharia de Dados e Desenvolvimento Backend.
